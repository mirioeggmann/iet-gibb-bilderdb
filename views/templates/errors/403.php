...
<main>
    <div class="container">
        <div class="section">
            <h2 class="light-blue-text text-darken-4">Error 403</h2>
        </div>
        <div class="section minbodyheight">
            <p>This section requires a password or is otherwise protected. If you feel you have reached this page in error,
                please return to the login page and try again, or contact the webmaster if you continue to have problems.</p>
            <a href="/home" type="button">Go to home page
            </a>
        </div>
    </div>
</main>
